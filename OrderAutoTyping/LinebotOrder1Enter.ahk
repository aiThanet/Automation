...
^l::
Gui, Destroy
InputBox, UserInput, LineBot Order ID, Please enter a order ID., , 200, 100
if ErrorLevel ;*[Untitled1]
{
	...
	API = http://mathongapi.jpn.local/linebot/order?linebot_order_id=%UserInput%
